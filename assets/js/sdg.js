...
var indicatorDataStore = function(dataUrl) {
  ...
  (function initialise() {
    ...
    that.fieldItemStates = _.map(_.filter(Object.keys(that.data[0]), function (key) {
        return ['Year', 'Value', 'Units', 'GeoCode', 'Observation status', 'Unit multiplier', 'Unit measure', 'Kreis'].indexOf(key) === -1;
      }), function(field) {
      return {
        field: field,
        hasData: true,
...
var mapView = function () {
  ...
  //---#2.1 caseNoTimeSeriesInCsv---stop-------------------------------------
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"min_zoom":5,"max_zoom":6,"serviceUrl":"https://nachhaltige-entwicklung-deutschland.github.io/open-sdg-site-starter/assets/maps/diy_lan.geojson","nameProperty":"GEN","idProperty":"AGS","staticBorders":true},{"min_zoom":6,"max_zoom":13,"serviceUrl":"https://nachhaltige-entwicklung-deutschland.github.io/open-sdg-site-starter/assets/maps/diy_krs.geojson","nameProperty":"GEN","idProperty":"AGS","staticBorders":false}],
      //---#1 GoalDependendMapColor---start--------------------------------------
      goal: goal,
      //---#1 GoalDependendMapColor---stop---------------------------------------
