  ...
  this.getData = function(options) {
    ...
    var options = _.defaults(options || {}, {
      ...
      convertToDataset = function (data, combinationDescription /*field, fieldValue*/) {
        ...
        //--------------------
        if (!nameList.includes(combinationDescription.substring(combinationDescription.indexOf(','), combinationDescription.length)) || combinationDescription.substring(combinationDescription.indexOf(',')) == -1 || (combinationDescription.substring(0, 4) != 'Ziel' && !combinationDescription.substring(0, 4) != 'Zeit')) {
...
var mapView = function () {
  ...
  this.initialise = function(geoData, geoCodeRegEx, goal) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"min_zoom":6,"max_zoom":10,"serviceUrl":"https://g205sdgs.github.io/sdg-indicators/assets/maps/NUTS_RG_01M_2016_3857_LEVL_1.geojson","nameProperty":"NUTS_NAME","idProperty":"NUTS_ID","staticBorders":false}],
      goal: goal,
    });
  };
};
