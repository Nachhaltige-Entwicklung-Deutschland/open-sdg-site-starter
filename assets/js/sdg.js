...
var indicatorDataStore = function(dataUrl) {
  ...
  this.getData = function(options) {
    ...
    var options = _.defaults(options || {}, {
      ...
      //--#14.1 barsOnly---start--------------------------------------------------------------------------------------------------------
      barCharts = ['indicator_2-2-a','indicator_3-1-e','indicator_3-3-a','indicator_5-1-b','indicator_5-1-c','indicator_5-1-e','indicator_6-2-ab','indicator_8-2-c','indicator_8-3-a',
