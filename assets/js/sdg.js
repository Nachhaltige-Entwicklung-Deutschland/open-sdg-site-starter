...
var mapView = function () {
  ...
  //---#2.1 caseNoTimeSeriesInCsv---stop-------------------------------------
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"min_zoom":5,"max_zoom":15,"serviceUrl":"https://nachhaltige-entwicklung-deutschland.github.io/open-sdg-site-starter/assets/maps/diy_lan.geojson","nameProperty":"GEN","idProperty":"Ars_0","staticBorders":false}],
      //---#1 GoalDependendMapColor---start--------------------------------------
      goal: goal,
      //---#1 GoalDependendMapColor---stop---------------------------------------
