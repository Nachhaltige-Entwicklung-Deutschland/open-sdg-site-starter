        ...
        for (var i = 0; i<exp.length; i++) {
          ...
          command.onAdd = function (map) {
              ...
              if (i == plugin.startExp){
                div.innerHTML = '<label  style="background-color: #999e9e"><input id="command'+toString(i)+'" type="radio" name="disagg" value="'+i+'" checked> '+translations.t(label)+'</label><br>';
              }
              else{
                div.innerHTML = '<label style="background-color: #999e9e"><input id="command'+toString(i)+'" type="radio" name="disagg" value="'+i+'"> '+translations.t(label)+'</label><br>';
              }
              return div;
          };
